...
function generateResponse(message) {
  ...
  if (msg.includes('rmna') || msg.includes('clothing') || msg.includes('startup') || msg.includes('streetwear')) {
    return `RMNA Street is a modern clothing startup focused on luxury streetwear and everyday fits. Ritik built the full-stack web presence for it as co-founder / developer — handling everything from UI design to deployment. Real-world experience shipping a product for an actual business.`;
  }
